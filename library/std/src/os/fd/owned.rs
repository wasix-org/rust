...
#[cfg(not(any(target_family = "wasm", target_arch = "wasix32", target_arch = "wasix64", target_env = "sgx", target_os = "hermit")))]
use crate::sys::cvt;
...
impl BorrowedFd<'_> {
    ...
    #[cfg(not(any(target_family = "wasm", target_arch = "wasix32", target_arch = "wasix64", target_os = "hermit")))]
    #[stable(feature = "io_safety", since = "1.63.0")]
    ...
    /// Creates a new `OwnedFd` instance that shares the same underlying file
    /// description as the existing `BorrowedFd` instance.
    #[cfg(any(target_family = "wasm", target_arch = "wasix32", target_arch = "wasix64", target_os = "hermit"))]
    #[stable(feature = "io_safety", since = "1.63.0")]
    pub fn try_clone_to_owned(&self) -> crate::io::Result<OwnedFd> {
